function validacionIdentificacion(numero) {
    var suma = 0;
    var residuo = 0;
    var pri = false;
    var pub = false;
    ...
    var codExtranjero = 30;
    var modulo = 11;


    // Longitud de Número de 10 y 13
    ...
    if (provincia == codExtranjero) {
        // Si el ciudadano obtuvo su cedula en el exterior
    } else if (provincia < 1 || provincia > numeroProvincias) {
