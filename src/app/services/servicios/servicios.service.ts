...
import { matriculacionRes } from 'src/app/models/matriculacionRes.model';
...
export class ServiciosService {
  ...
  //***serv Matriculacion */
  getTodoPropiedadesVehiculo() {
    return this.http.get<matriculacionRes>(`${environment.URL_SERVICIOS}/vehiculo/findAllPropVeh`);
  }
